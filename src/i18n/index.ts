...
const ko = {
  ...
  'my.settings': '설정',
  'my.credits': '사진 출처',
  'my.creditsBody': '주변 장소 사진 {n}장을 {who}에서 받았습니다. 공공누리 제1·3유형이라 출처를 표시하고 씁니다.',
...
const en: Messages = {
  ...
  'my.creditsBody': '{n} photos of nearby places come from {who}. They are public-licence photos (KOGL type 1 and 3) used with attribution.',
...
const ja: Messages = {
  ...
  'my.settings': '設定',
  'my.credits': '写真の出典',
  'my.creditsBody': '周辺の場所の写真{n}枚は{who}から提供を受けています。公共ヌリ第1・3類型として出典を明記して使用しています。',
...
const zh: Messages = {
  ...
  'my.settings': '设置',
  'my.credits': '照片来源',
  'my.creditsBody': '周边地点的 {n} 张照片来自{who}。这些照片属韩国公共数据开放许可(KOGL)第1·3类型，标注出处后使用。',
