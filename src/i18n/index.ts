...
const ko = {
  ...
  'my.settings': '설정',
  'my.credits': '사진 출처',
  'my.creditsBody': '도서관 사진 {libs}장과 주변 장소 사진 {places}장을 {who}에서 받았습니다. 공공누리 제1·3유형이라 출처를 표시하고 씁니다.',
...
const en: Messages = {
  ...
  'my.credits': 'Photo credits',
  'my.creditsBody': '{libs} library photos and {places} photos of nearby places come from {who}. They are public-licence photos (KOGL type 1 and 3) used with attribution.',
...
const ja: Messages = {
  ...
  'my.settings': '設定',
  'my.credits': '写真の出典',
  'my.creditsBody': '図書館の写真{libs}枚と周辺の場所の写真{places}枚は{who}から提供を受けています。公共ヌリ第1・3類型として出典を明記して使用しています。',
...
const zh: Messages = {
  ...
  'my.settings': '设置',
  'my.credits': '照片来源',
  'my.creditsBody': '{libs} 张图书馆照片和 {places} 张周边地点照片来自{who}。这些照片属韩国公共数据开放许可(KOGL)第1·3类型，标注出处后使用。',
