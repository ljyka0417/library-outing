...
const SEEDS: Seed[] = [
  ...
  { id: 'nonhyeon-maru', name: '논현문화마루도서관', sido: '서울', specialty: '예술·디자인', categories: ['art'] },
  ...
  { id: 'goyang-hwajeong', name: '고양화정도서관', sido: '경기', specialty: '예술', categories: ['art'] },
  ...
  { id: 'uijeongbu-art', name: '의정부미술도서관', sido: '경기', specialty: '예술', categories: ['art'] },
  { id: 'uijeongbu-music', name: '의정부음악도서관', sido: '경기', specialty: '음악', categories: ['music'] },
  ...
  { id: 'majeon-library', name: '마전도서관', sido: '인천', specialty: '자연·환경', categories: ['nature'] },
  { id: 'cheongna-intl', name: '청라국제도서관', sido: '인천', specialty: '어학', categories: ['language'] },
  { id: 'yeongjong-sky', name: '영종하늘도서관', sido: '인천', specialty: '미술·그림책', categories: ['art'] },
  { id: 'yulmok-library', name: '율목도서관', sido: '인천', specialty: '인문', categories: ['humanities'] },
  { id: 'dongchun-narae', name: '동춘나래도서관', sido: '인천', specialty: '예술', categories: ['art'] },
